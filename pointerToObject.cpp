// when we does (*ptr) in int main function we actually wants to access object public members through pointers .


// pointer concept:  (*ptr) -  dereference meaning value.      &a= address of that a. 
