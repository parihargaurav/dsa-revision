// this is special keyword in cpp which is a pointer which points to the objects which is invokes the member function.

// in cpp the major priority is given to local variables in classess



// this pointer uss object ko point karta hai jisne member function call kiya
...
As shown in a code snippet 1,
    ...
    The Function “setData” will take one parameters and assign the values of parameter to the private data members “a” using “this” pointer. As we know that one copy of member function is shared between all object. The use of “this” pointer helps to points to the object which invokes the member function.
